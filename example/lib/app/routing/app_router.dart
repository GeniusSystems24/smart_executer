...
import 'package:smart_executer_example/features/basic_usage/presentation/pages/basic_usage_page.dart';
import 'package:smart_executer_example/features/exception_handling/presentation/pages/exception_handling_page.dart';
import 'package:smart_executer_example/features/home/presentation/pages/home_page.dart';
import 'package:smart_executer_example/features/loading_dialogs/presentation/pages/loading_dialogs_page.dart';
import 'package:smart_executer_example/features/status_cards/presentation/pages/status_cards_page.dart';
import 'package:smart_executer_example/features/scenarios/form_submit/presentation/pages/form_submit_scenario.dart';
import 'package:smart_executer_example/features/scenarios/full_integration/presentation/pages/full_integration_scenario.dart';
import 'package:smart_executer_example/features/scenarios/product_cards/presentation/pages/product_cards_scenario.dart';
import 'package:smart_executer_example/features/scenarios/user_list/presentation/pages/user_list_scenario.dart';
import 'package:smart_executer_example/features/examples/examples.dart';
import 'package:smart_executer_example/features/examples_gallery/presentation/pages/examples_gallery_page.dart';
...
@TypedGoRoute<HomeRoute>(
  ...
  routes: <TypedGoRoute<GoRouteData>>[
    // Feature Pages
    TypedGoRoute<BasicUsageRoute>(path: RoutePaths.basicUsage),
    TypedGoRoute<StatusCardsRoute>(path: RoutePaths.statusCards),
    TypedGoRoute<LoadingDialogsRoute>(path: RoutePaths.loadingDialogs),
    TypedGoRoute<ExceptionHandlingRoute>(path: RoutePaths.exceptionHandling),
    // Scenario Pages
    TypedGoRoute<UserListRoute>(path: RoutePaths.userList),
    TypedGoRoute<FormSubmitRoute>(path: RoutePaths.formSubmit),
    TypedGoRoute<ProductCardsRoute>(path: RoutePaths.productCards),
    TypedGoRoute<FullIntegrationRoute>(path: RoutePaths.fullIntegration),
    // Examples Gallery
    TypedGoRoute<ExamplesGalleryRoute>(path: RoutePaths.examplesGallery),
    // Execution Patterns
    TypedGoRoute<SequentialExecutionRoute>(path: RoutePaths.sequentialExecution),
    TypedGoRoute<ParallelExecutionRoute>(path: RoutePaths.parallelExecution),
    TypedGoRoute<DebounceThrottleRoute>(path: RoutePaths.debounceThrottle),
    // Retry Patterns
    TypedGoRoute<AutoRetryRoute>(path: RoutePaths.autoRetry),
    // UI Patterns
    TypedGoRoute<PullToRefreshRoute>(path: RoutePaths.pullToRefresh),
    TypedGoRoute<OptimisticUpdateRoute>(path: RoutePaths.optimisticUpdate),
    TypedGoRoute<SkeletonLoadingRoute>(path: RoutePaths.skeletonLoading),
    // Connectivity
    TypedGoRoute<OfflineModeRoute>(path: RoutePaths.offlineMode),
    // Data Management
    TypedGoRoute<CrudOperationsRoute>(path: RoutePaths.crudOperations),
    // Error Builders
    TypedGoRoute<SnackBarErrorBuilderRoute>(path: RoutePaths.snackBarErrorBuilder),
    TypedGoRoute<DialogErrorBuilderRoute>(path: RoutePaths.dialogErrorBuilder),
    TypedGoRoute<ScaffoldKeyRoute>(path: RoutePaths.scaffoldKey),
    TypedGoRoute<ExceptionBuilderRoute>(path: RoutePaths.exceptionBuilder),
  ],
)
